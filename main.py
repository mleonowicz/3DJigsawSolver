...
def main():
    parser = argparse.ArgumentParser(prog="3DJigsawSolver")
    parser.add_argument(
        "--video-path",
        type=str,
        default="example/example-2.mp4",
    )
    parser.add_argument("--pieces-number-x", type=int, default=15)
    parser.add_argument("--pieces-number-y", type=int, default=15)
    parser.add_argument("--pieces-number-z", type=int, default=15)
    ...
    parser.add_argument("--elites", default=15, type=int)
    parser.add_argument("--population-size", default=500, type=int)
    parser.add_argument("--max-iterations", default=100, type=int)
    parser.add_argument("--output-path", default="output.dat", type=str)
    ...
    save_puzzle_video("result.avi", p, metadata)
